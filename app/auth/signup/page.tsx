        ...
        <div className='flex-grow flex items-center justify-center p-8'>
          <div className='w-full max-w-md'>
            ...
            <p className='text-lg text-gray-300 mb-10'>
              Join thousands of users creating with AI-powered document
              processing.
            </p>
      ...
      <div className='hidden lg:block lg:w-1/2 bg-gray-50 p-8'>
        <div className='h-full rounded-lg bg-white shadow-sm p-6 flex items-center justify-center'>
          <div className='text-center'>
            <div className='inline-block w-12 h-12 rounded-full bg-green-100 mb-4 flex items-center justify-center'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                width='24'
                height='24'
